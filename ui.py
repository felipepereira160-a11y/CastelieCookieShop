...
def inject_base_css():
    st.markdown(
        ...
        <style>
            ...
            .stApp {
                background: radial-gradient(1200px 600px at 10% -10%, #EBD7C5 0%, rgba(235,215,197,0.6) 50%, rgba(235,215,197,0) 70%),
                            radial-gradient(900px 500px at 90% 0%, #D6B89B 0%, rgba(214,184,155,0.4) 45%, rgba(214,184,155,0) 70%),
                            var(--cream);
            }
            ...
            .hero {
                padding: 24px 28px;
                border-radius: 18px;
                background: linear-gradient(120deg, #E9D0BB 0%, #D7B092 45%, #C79C7E 100%);
                border: 1px solid rgba(62,38,26,0.18);
            ...
            .card {
                ...
                border-radius: 16px;
                background: #F4E6D7;
                border: 1px solid rgba(62,38,26,0.12);
