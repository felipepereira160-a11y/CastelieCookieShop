...
def admin_theme_save(
    ...
    hero_padding: int = Form(24),
    hero_title_size: int = Form(26),
    hero_text_size: int = Form(15),
    ...
    theme = {
        ...
        "hero_padding": max(16, min(48, int(hero_padding))),
        "hero_title_size": max(20, min(36, int(hero_title_size))),
        "hero_text_size": max(12, min(20, int(hero_text_size))),
